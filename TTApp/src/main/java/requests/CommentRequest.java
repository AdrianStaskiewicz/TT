...
public class CommentRequest {
    ...
    public CommentDto findById(Long commentId) {
        ...
        HttpEntity<Long> requestUpdate = new HttpEntity<>(commentId, null);

        ResponseEntity<CommentDto> response = restTemplate.exchange(Settings.URL + CATEGORY + "get", HttpMethod.POST, requestUpdate, CommentDto.class);
        CommentDto result = response.getBody();
